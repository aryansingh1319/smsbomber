...
#------------------------------------------------------#
#                   XLR8 BOMBER 2.1 !                  #
#               Coded by Aryan Singh (AMAN)            #
#~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ #
#      Github     :   github.com/aryansingh1319        #
#     Instagram  :  instagram.com/iamasr13             #
#------------------------------------------------------#
...
echo ""
sleep 1
echo "                                    $WHITE Author:$RED Aryan Singh"
echo ""

}

#    Check Internet
wget -q --spider https://github.com/aryansingh1319
...
wget -L https://raw.githubusercontent.com/aryansingh1319/serverxlr8/main/.server.txt  > /dev/null 2>&1
serverup="On"
...
cd ..
rm -rf XLR8_BOMBER
git clone https://github.com/aryansingh1319/smsbomber > /dev/null 2>&1
cd smsbomber
chmod +x sms.sh
clear
echo ""
...
sleep 3
echo ""
echo -e "        \e[92m[\e[91m~\e[92m]\e[91m Restarting sms !\e[93m"
sleep 2
bash sms.sh
}
...
''' | pv -qL 300
sleep 1.2
echo -e "                                  This is\e[1;0m 𝗔ryan Singh�" | pv -qL 150
echo "                                    aka aryansingh1319 !" | pv -qL 150
echo ""
...
echo ""
printf "\e[0m\e[92m          Github \e[0m\e[91m     :    \e[0m\e[96mgithub.com/aryansingh1319\e[0m\n" | pv -qL 50
echo ""
printf "\e[0m\e[92m         Instagram \e[0m\e[91m   :   \e[0m\e[96minstagram.com/iamasr13s\e[0m\n" | pv -qL 50
echo ""
...
if [ "$options" -eq "5" ];then
        echo ""
        echo -e "\e[92m[\e[91m~\e[92m]\e[93m Thanks for Using smsbomber !\e[93m"
        echo ""
        exit
else
        menux
